...
public class EditShopProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProfileUtils.getParseUserProfileImage(utente.getUsername(),profile_picture,getApplicationContext(),false,EditShopProfileActivity.this);
    ...
    public void onResume() {
        ...
        ProfileUtils.getParseUserProfileImage(ParseUser.getCurrentUser().getUsername(),profile_picture,getApplicationContext(),false,EditShopProfileActivity.this);
    }
